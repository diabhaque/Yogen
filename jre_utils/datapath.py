...
model_ready_data_paths = {
    ...
    "xgb_transactions_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_1.csv",
    "xgb_transactions_weighted_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_mean_1.csv",
    "xgb_transactions_weighted_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_median_1.csv",
    "xgb_transactions_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_mean_1.csv",
    "xgb_transactions_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_median_1.csv",
    "sequence_transactions_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_1.csv",
    "sequence_transactions_weighted_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_weighted_mean_1.csv",
    "sequence_transactions_weighted_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_weighted_median_1.csv",
    "sequence_transactions_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_mean_1.csv",
    "sequence_transactions_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_median_1.csv",
    "xgb_plps_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_1.csv",
    "xgb_plps_weighted_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_mean_1.csv",
    "xgb_plps_weighted_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_median_1.csv",
    "xgb_plps_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_mean_1.csv",
    "xgb_plps_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_median_1.csv",
    "sequence_plps_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_1.csv",
    "sequence_plps_weighted_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_weighted_mean_1.csv",
    "sequence_plps_weighted_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_weighted_median_1.csv",
    "sequence_plps_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_mean_1.csv",
    "sequence_plps_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_median_1.csv",
    "xgb_lpa_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_1.csv",
    "xgb_lpa_weighted_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_mean_1.csv",
    "xgb_lpa_weighted_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_median_1.csv",
    "xgb_lpa_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_mean_1.csv",
    "xgb_lpa_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_median_1.csv",
    "sequence_lpa_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_1.csv",
    "sequence_lpa_weighted_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_weighted_mean_1.csv",
    "sequence_lpa_weighted_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_weighted_median_1.csv",
    "sequence_lpa_mean_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_mean_1.csv",
    "sequence_lpa_median_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_median_1.csv",
    "xgb_transactions_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_2.csv",
    "xgb_transactions_weighted_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_mean_2.csv",
    "xgb_transactions_weighted_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_median_2.csv",
    "xgb_transactions_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_mean_2.csv",
    "xgb_transactions_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_median_2.csv",
    "sequence_transactions_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_2.csv",
    "sequence_transactions_weighted_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_weighted_mean_2.csv",
    "sequence_transactions_weighted_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_weighted_median_2.csv",
    "sequence_transactions_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_mean_2.csv",
    "sequence_transactions_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_median_2.csv",
    "xgb_plps_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_2.csv",
    "xgb_plps_weighted_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_mean_2.csv",
    "xgb_plps_weighted_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_median_2.csv",
    "xgb_plps_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_mean_2.csv",
    "xgb_plps_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_median_2.csv",
    "sequence_plps_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_2.csv",
    "sequence_plps_weighted_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_weighted_mean_2.csv",
    "sequence_plps_weighted_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_weighted_median_2.csv",
    "sequence_plps_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_mean_2.csv",
    "sequence_plps_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_median_2.csv",
    "xgb_lpa_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_2.csv",
    "xgb_lpa_weighted_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_mean_2.csv",
    "xgb_lpa_weighted_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_median_2.csv",
    "xgb_lpa_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_mean_2.csv",
    "xgb_lpa_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_median_2.csv",
    "sequence_lpa_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_2.csv",
    "sequence_lpa_weighted_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_weighted_mean_2.csv",
    "sequence_lpa_weighted_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_weighted_median_2.csv",
    "sequence_lpa_mean_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_mean_2.csv",
    "sequence_lpa_median_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_median_2.csv",
}
