...
model_ready_data_paths = {
    "xgb_transactions_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_smoothed_1.csv",
    "xgb_transactions_weighted_mean_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_mean_smoothed_1.csv",
    "xgb_transactions_weighted_median_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_median_smoothed_1.csv",
    "xgb_transactions_mean_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_mean_smoothed_1.csv",
    "xgb_transactions_median_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_median_smoothed_1.csv",
    "sequence_transactions_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_smoothed_1.csv",
    ...
    "xgb_plps_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_smoothed_1.csv",
    "xgb_plps_weighted_mean_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_mean_smoothed_1.csv",
    "xgb_plps_weighted_median_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_median_smoothed_1.csv",
    "xgb_plps_mean_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_mean_smoothed_1.csv",
    "xgb_plps_median_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_median_smoothed_1.csv",
    "sequence_plps_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_smoothed_1.csv",
    ...
    "xgb_lpa_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_smoothed_1.csv",
    "xgb_lpa_weighted_mean_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_mean_smoothed_1.csv",
    "xgb_lpa_weighted_median_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_median_smoothed_1.csv",
    "xgb_lpa_mean_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_mean_smoothed_1.csv",
    "xgb_lpa_median_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_median_smoothed_1.csv",
    "sequence_lpa_smoothed_1": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_smoothed_1.csv",
    ...
    "xgb_transactions_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_smoothed_2.csv",
    "xgb_transactions_weighted_mean_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_mean_smoothed_2.csv",
    "xgb_transactions_weighted_median_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_weighted_median_smoothed_2.csv",
    "xgb_transactions_mean_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_mean_smoothed_2.csv",
    "xgb_transactions_median_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_transactions_median_smoothed_2.csv",
    "sequence_transactions_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_transactions_smoothed_2.csv",
    ...
    "xgb_plps_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_smoothed_2.csv",
    "xgb_plps_weighted_mean_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_mean_smoothed_2.csv",
    "xgb_plps_weighted_median_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_weighted_median_smoothed_2.csv",
    "xgb_plps_mean_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_mean_smoothed_2.csv",
    "xgb_plps_median_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_plps_median_smoothed_2.csv",
    "sequence_plps_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_plps_smoothed_2.csv",
    ...
    "xgb_lpa_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_smoothed_2.csv",
    "xgb_lpa_weighted_mean_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_mean_smoothed_2.csv",
    "xgb_lpa_weighted_median_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_weighted_median_smoothed_2.csv",
    "xgb_lpa_mean_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_mean_smoothed_2.csv",
    "xgb_lpa_median_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/xgb_lpa_median_smoothed_2.csv",
    "sequence_lpa_smoothed_2": f"{DATA_DIRECTORY_PATH}/model_ready/sequence_lpa_smoothed_2.csv",
